...
- `uc.blended-addressbar.frame-shadow`: choose the browser frame shadow preset: standard, minimal, or medium. Minimal adds a 0.5pt white inner highlight and a black outer shadow, both at 20% opacity, with a 0.5pt outer edge.
